...
const TOOLS = [
  ...
  {
    name: "Hacking",
    content: "Kali Linux is a linux distribution for hacking",
    icon: <FaHackerrank size={"50px"} color="#e34c26" />,
    color: "#e34c26",
  },
  {
    name: "CSS",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">The Fox</p>
                <div className="text-xs bg-zinc-700 w-fit px-3 py-1 rounded-full">
                engineering science expert, Ethical Hacker 
                </div>
              </div>
            </div>
