...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const serviceID = 'service_h0mghyh'; // Remplacez par votre Service ID
    const templateID = 'template_wd3oi2r'; // Votre Template ID
    const userID = 'xhEzCTlY9vgPZf7F6'; // Votre User ID (Public Key)
